...
const GUIDE_SECTIONS = [
	{
		...
		description: "Learn the 9 simple rules for beginners. Serving, scoring, kitchen, and more.",
		href: "/guides",
	},
	{
		title: "What is my skill rating?",
		description: "Take a quiz to get rated. Understand 2.0, 3.0, 4.0+ and how to improve.",
		href: "/guides",
	},
	{
		title: "Best pickleball paddles",
		description:
			"Gear guides and reviews: paddles, balls, bags. Find the right paddle for your game.",
		href: "/paddles",
	},
	{
		title: "Find courts & games",
		description: "Use our court finder and play sessions to find places to play and games to join.",
		href: "/courts",
	},
	{
		title: "Run a round robin",
		description: "Organize round robins, leagues, and ladders. Use sessions and tournaments here.",
		href: "/sessions",
	},
];
		...
		<div className="min-h-screen bg-gray-50 dark:bg-gray-950">
			...
			<main className="container mx-auto px-4 py-8 max-w-4xl">
				...
				<p className="mt-10 text-sm text-gray-500 dark:text-gray-400">
					Want to find a lesson? Check the{" "}
					<Link to="/home" className="text-emerald-600 dark:text-emerald-400 hover:underline">
						Lessons
					</Link>{" "}
					tab on Home for local coaches.
				</p>
			</main>
		</div>
	);
